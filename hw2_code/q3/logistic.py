...
def logistic_predict(weights, data):
    ...
    #####################################################################
    y = sigmoid(np.dot(data, weights[:-1]))
    #####################################################################
    #                       END OF YOUR CODE                            #
    #####################################################################
    return y
...
def evaluate(targets, y):
    ...
    for p in y:
        if p > 0.5:
            ...
            y_n.append([0])
    frac_correct = np.sum(y_n == targets) / len(targets)
    #####################################################################
    #                       END OF YOUR CODE                            #
    #####################################################################
...
def logistic(weights, data, targets, hyperparameters):
    ...
    df_w = np.dot(data.T, y - targets)
    df_b = np.zeros(weights[-1].shape)
    df = np.append(df_w, [df_b], axis=0)
    #####################################################################
    #                       END OF YOUR CODE                            #
    #####################################################################
    return f, df, y